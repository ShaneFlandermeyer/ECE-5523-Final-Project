...
class loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "ECE 5523 Loopback", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ECE 5523 Loopback")
        ...
        self.uhd_usrp_source_0.set_start_time(uhd.time_spec(1))
